  ...
  return (
    <Layout>
      ...
      <div className={layout.container__main}>
        <h1>Research</h1>
        <p>The research at GRAPPA lies at the intersection of astrophysics, theoretical physics, particle/high-energy physics, and cosmology. We focus on four core research directions.</p>
